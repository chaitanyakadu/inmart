  ...
  try {
    ...
    const aiMsg = await llm.invoke([
      [
        "system",
        `
          You are a trained Sales Agent. You receive client enquiries in structured JSON format.
      ...
      [
        "human",
        `{msg_text_json:${params.chatDetails.msg_text_json}, "msg_prod_name":${params.chatDetails.msg_prod_name}, "msg_mcat_name:${params.chatDetails.msg_mcat_name}, "agent_name":${filterData.fullName}, "agent_company":${filterData.company_name}}`,
      ],
    ]);
